#!/usr/bin/env bash
#
# Generate EasyCommerce stubs from the source directory.
#
# This script generates type declaration stubs for the EasyCommerce plugin,
...
HEADER=$'/**\n * Generated stub declarations for EasyCommerce.\n * @see https://wordpress.org/plugins/easycommerce/\n * @see https://github.com/mralaminahamed/phpstan-easycommerce-stubs\n */'
FILE="$ROOT_DIR/easycommerce-stubs.stub"
FILE_CONSTANTS="$ROOT_DIR/easycommerce-constants-stubs.stub"
...
[[ -d "$ROOT_DIR/source/easycommerce" ]] || error_exit "EasyCommerce source not found at $ROOT_DIR/source/easycommerce"
